...
public class GetFeedPresenter extends BasePresenter<MamCallback>{
    private Context context;
    public GetFeedPresenter(Context context){
        this.context = context;
    }
    public void getFeed(String start,String count,String sort,String by,String credential){
        Call<GetFeedResponse> call = MamService.createWithHeader(setHeader(credential))
                .getFeed(start,count,sort,by);
